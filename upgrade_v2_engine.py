...
MAIN_PATH = Path("v2_engine/main.py")
...
def upgrade():
    ...
    MAIN_PATH.write_text(NEW_MAIN.strip())
    print("[SUCCESS] v2_engine/main.py fully upgraded.")
